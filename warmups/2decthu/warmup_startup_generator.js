...
//console.log(thisArray.length, thatArray.length);
//let userName = String(process.argv[2]);
let randomNumThat = Math.floor (Math.random() * thatArray.length);
let randomNumThis = Math.floor (Math.random() * thisArray.length);
let randomThat = thatArray[randomNumThat];
//console.log(randomNumThis);

//console.log(randomNumThat);
let randomThis = thisArray[randomNumThis];
randomThat = thatArray[randomNumThat];
function randomObject () {
    for (let i=0; i<10; i++) {
        randomNumThis = Math.floor (Math.random() * thisArray.length);
        randomThis = thisArray[randomNumThis];
        user.ideas.push(randomThis + " for " + randomThat);        
    }console.log(user);
}randomObject();
...
//     console.log (`Hey , got an idea for you!
// ${randomThis} for ${randomThat}`);
// } else {
//     console.log (`Hey ${userName} , got an idea for you!
//     ${randomThis} for ${randomThat}`); 
// }
