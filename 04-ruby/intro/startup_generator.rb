...
# puts(this_array) # puts is always trying to make things pretty for you
...
# random_index_this_array = (rand * this_array.length).floor
# # puts(random_index)

# random_idea = this_array[random_index_this_array]

# random_index_that_array
